...
Nous avons décider d'utiliser Fetch plutôt que XHR car cela était plus facile et propre.
...
Il est possible, si le personnage existe sur la deuxième API, de cliquer sur le nom du personnage pour accéder à sa page sur le site MyAnimeList que l'API Jikan utilise.